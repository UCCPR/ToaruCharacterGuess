...
describe('database schema initialization', () => {
  it('creates the current schema and remains idempotent', async () => {
    ...
    expect(await instance.schema.hasTable('catalog_sources')).toBe(true);
    expect(await instance.schema.hasTable('characters')).toBe(true);
    expect(await instance.schema.hasTable('character_aliases')).toBe(true);
    expect(await instance.schema.hasTable('works')).toBe(true);
    expect(await instance.schema.hasTable('sides')).toBe(true);
    expect(await instance.schema.hasTable('character_sides')).toBe(true);
    expect(await instance.schema.hasTable('organizations')).toBe(true);
    expect(await instance.schema.hasTable('character_organizations')).toBe(true);
    expect(await instance.schema.hasTable('abilities')).toBe(false);
    expect(await instance.schema.hasTable('character_abilities')).toBe(false);
    expect(await instance.schema.hasTable('locations')).toBe(true);
    expect(await instance.schema.hasTable('character_locations')).toBe(true);
    expect(await instance.schema.hasTable('character_appearances')).toBe(true);
    expect(await instance.schema.hasTable('character_game_profiles')).toBe(true);
    expect(await instance.schema.hasTable('character_references')).toBe(true);
    ...
    expect(await instance.schema.hasColumn('characters', 'legacy_player_id')).toBe(false);
    ...
    expect(await instance('sides').orderBy('key').pluck('key')).toEqual([
      'independent',
      'magic',
      'science',
      'unknown',
