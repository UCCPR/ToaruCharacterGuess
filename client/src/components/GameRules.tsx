            ...
            >
              ...
              <div className="game-rules-dialog-body">
                ...
                <div className="rule-sections">
                  ...
                  <article className="rule-panel rule-panel-regions">
                    <div className="rule-panel-title">
                      <span aria-hidden="true"><Flag size={20} /></span>
                      <div><small>04</small><h3>{t('rules.sidesTitle')}</h3></div>
                    </div>
                    <p>{t('rules.sidesIntro')}</p>
                    <div className="region-list">
                      {sides.map((side) => (
                        <div className="region-item" key={side}>
                          <strong>{t(`rules.sides.${side}.name`)}</strong>
                          <span>{t(`rules.sides.${side}.description`)}</span>
                        </div>
                      ))}
                    </div>
                  </article>
