        ...
        {player ? (
          <div className="card">
            <h3>
              ...
              {player.localizedNames?.[i18n.language.split('-')[0] as 'zh' | 'en' | 'ja'] || player.nickname}
              <span className="muted" style={{ fontWeight: 400 }}>
                {player.isActive ? t('common.active') : t('common.retired')}
              </span>
            </h3>
            <PlayerInfoTable
              answer={{
                ...
                localizedNames: player.localizedNames,
                team: player.team,
