...
export default function Home() {
  ...
  const displayedGuestName = localizeDisplayName(t, guestName);
    ...
    <div className="page home-page">
      ...
      <div className="header-bar">
        <div className="home-brand">
          ...
          <span className="home-brand-logo" aria-hidden="true"><Sparkles size={22} /></span>
        ...
        <span className="btns">
          ...
          {!initialized ? (
            ...
            <>
              <span className="muted">{displayedGuestName}</span>
      ...
      <main className="page-scroll" id="main-content">
        <div className="home-hero">
          ...
          <p className="muted">{t('home.fanDisclaimer')}</p>
          <GameRules />
          {initialized && !user && (
