...
describe('Home email verification reminder', () => {
  ...
  it('places single-player mode as the first home menu entry', () => {
    renderAtRoute(<Home />);

    const single = screen.getByRole('link', { name: /单人模式/ });
    expect(single.parentElement?.firstElementChild).toBe(single);
  });
